...
class ClienteControllerTest {
	...
	public void cadastraClienteTest() {
		...
		assertThrows(IllegalArgumentException.class, () -> this.c.cadastraClientes("12345678901", "Lucas", "lucas.lucena@ccc.ufcg.edu.br", "lcc3"));
		assertThrows(IllegalArgumentException.class, () -> this.c.cadastraClientes("12345678901", "lucas", "lucas@ccc.ufcg.edu.br", "lcc3"));
		assertThrows(IllegalArgumentException.class, () -> this.c.cadastraClientes("12345678901", "lucas", "lucas.lucena@ccc.ufcg.edu.br", "lcc2"));
		
		assertThrows(IllegalArgumentException.class, () -> this.c.cadastraClientes(null, "lucas", "lucas.lucena@ccc.ufcg.edu.br", "lcc3"));
		assertThrows(IllegalArgumentException.class, () -> this.c.cadastraClientes("", "lucas", "lucas.lucena@ccc.ufcg.edu.br", "lcc3"));
		assertThrows(IllegalArgumentException.class, () -> this.c.cadastraClientes("1234567890", "lucas", "lucas.lucena@ccc.ufcg.edu.br", "lcc3"));
		assertThrows(IllegalArgumentException.class, () -> this.c.cadastraClientes("123456789012", "lucas", "lucas.lucena@ccc.ufcg.edu.br", "lcc3"));
		
		assertThrows(IllegalArgumentException.class, () -> this.c.cadastraClientes("11111111111", null, "lucas.lucena@ccc.ufcg.edu.br", "lcc3"));
		assertThrows(IllegalArgumentException.class, () -> this.c.cadastraClientes("11111111111", "", "lucas.lucena@ccc.ufcg.edu.br", "lcc3"));
		
		assertThrows(IllegalArgumentException.class, () -> this.c.cadastraClientes("11111111111", "lucas", null, "lcc3"));
		assertThrows(IllegalArgumentException.class, () -> this.c.cadastraClientes("11111111111", "lucas", "", "lcc3"));
		
		assertThrows(IllegalArgumentException.class, () -> this.c.cadastraClientes("11111111111", "lucas", "lucas.lucena@ccc.ufcg.edu.br", null));
		assertThrows(IllegalArgumentException.class, () -> this.c.cadastraClientes("11111111111", "lucas", "lucas.lucena@ccc.ufcg.edu.br", ""));
	}
	...
	public void exibeTodoOsClientesTest() {
		...
		assertEquals(c.exibeTodosOsClientes(), "lucas - lcc3 - lucas.lucena@ccc.ufcg.edu.br | mateus - lcc2 - mateus@ccc.ufcg.edu.br");
	}
