...
class ClienteTest {
	...
	@Test
	void construtorTest() {
		assertThrows(IllegalArgumentException.class, () -> new Cliente(null , "lucas", "lucas.lucena@ccc.ufcg.edu.br", "lcc3"));
		assertThrows(IllegalArgumentException.class, () -> new Cliente("" , "lucas", "lucas.lucena@ccc.ufcg.edu.br", "lcc3"));
		assertThrows(IllegalArgumentException.class, () -> new Cliente("123456789012" , "lucas", "lucas.lucena@ccc.ufcg.edu.br", "lcc3"));
		assertThrows(IllegalArgumentException.class, () -> new Cliente("1234567890" , "lucas", "lucas.lucena@ccc.ufcg.edu.br", "lcc3"));
	
		assertThrows(IllegalArgumentException.class, () -> new Cliente("12345678901" , null, "lucas.lucena@ccc.ufcg.edu.br", "lcc3"));
		assertThrows(IllegalArgumentException.class, () -> new Cliente("12345678901" , "", "lucas.lucena@ccc.ufcg.edu.br", "lcc3"));
		...
		assertThrows(IllegalArgumentException.class, () -> new Cliente("12345678901" , "lucas", "lucas.lucena@ccc.ufcg.edu.br", null));
		assertThrows(IllegalArgumentException.class, () -> new Cliente("12345678901" , "lucas", "lucas.lucena@ccc.ufcg.edu.br", ""));
	}
